...
if ($form_submission == 'yes') :
    ...
    eticket_add_bus($busName, $busNumber, $busCondition,$holiday, $busRoute, $startTime, $endTime, $totalSeat, $date, $busStatus);
                ...
                <div class="modal-body">
                    <form action="" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-6 mb-3">
                                <label for="holiday" class="col-form-label">Holiday</label>
                                <select class="form-select status" name="holiday" id="holiday">
